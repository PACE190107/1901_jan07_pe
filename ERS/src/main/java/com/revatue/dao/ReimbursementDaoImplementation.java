...
//Method to make a new reimbursement///////////////////////////////////////////////////////////////////			
		...
		try (Connection conn = JDBCConnectionUtil.getConnection() ){
			String sql= ("INSERT INTO REIMBURSEMENTS (REQ_ID, E_ID, DATE_RECEIVED, REQ_TYPE, AMOUNT, REQ_DESCRIPTION) VALUES(REQ_ID_SEQ,?,?,?,?,?)");
...
// approveDeny/////////////////////////////////////////
		...
		//////////////////	
			...
			@Override
			public Reimbursement newRequest(int e_id, String date_received, String type, double amount,
					String description) {
				// TODO Auto-generated method stub
				return null;
			}
