...
public class ScreenManager {
	public static final byte HOME_SCREEN = 0, NEW_USER_SCREEN = 1, LOGIN_SCREEN = 2, DELETE_SCREEN = 3, ACCOUNT_SCREEN = 4,
			BALANCE_SCREEN = 5, DEPOSIT_SCREEN = 6, WITHDRAWAL_SCREEN = 7, HISTORY_SCREEN = 8,
	...
	private static String[] screens = {
			...
			"\n" +
			"\n" +
			"[AccountID*, AccountType*, Account Balance*] \n" +
			...
			//CREATION_SCREEN
			"\n" +
			"Choose the type of bank account you would like to create from the options below, then enter the initial deposit amount. \n" +
			"1. Checking \n" +
			"1. Savings \n" +
			"Enter 'back' to return to the account menu. \n" +
			"\n",
	...
	public static void updateScreens(String username, String accountInformation) {
	...
	public static void updateSuperScreen(String userCredentials) {
		screens[USER_SCREEN] =
				"\n" +
				"\n" +
				userCredentials +
